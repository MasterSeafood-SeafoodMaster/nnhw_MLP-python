...
class MyApp(tk.Tk):
	...
	def initUI(self):
		...
		self.setEntry(self.Path, (200, 360), "./DataSet/Basic/2Ccircle1.txt", 30)
		self.setEntry(self.Classes, (200, 400), "1, 2", 10)
		self.setEntry(self.Epochs, (200, 440), "50", 10)
		self.setEntry(self.Learning_rate, (200, 480), "0.1", 10)
		self.setEntry(self.Model_shape, (200, 520), "2, 20, 1", 10)

		self.setButton("Train!", (20, 600), self.Train)
		self.setButton("Draw_line!", (200, 600), self.draw_line)
	...
	def draw_picture(self, points):
		...
		ax0.set_title("Prediction", font=("MV Boli"), fontsize=16)
		ax1.set_title("Dataset_Y", font=("MV Boli"), fontsize=16)
